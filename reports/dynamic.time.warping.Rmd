...
for (experiment.name in names(DYAD_EXPERIMENTS)) {
  ...
  models = list(
    ...
    'periodicity.duplex.symmetrical' = experiment$models$`mami.codi.m.1.t.1.h.1.l.-1.r.73.5759`,
    'periodicity.duplex.asymmetrical.high' = experiment$models$`mami.codi.m.1.t.1.h.2.l.-1.r.73.5759`,
    'periodicity.duplex.asymmetrical.low' = experiment$models$`mami.codi.m.1.t.1.h.1.l.-2.r.73.5759`,
